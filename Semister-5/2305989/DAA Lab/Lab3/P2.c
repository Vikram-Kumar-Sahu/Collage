...
int main()
{
    ...
    while (1)
    {
        ...
        {
            case 1:
                strcpy(inFile, "inQuickAsce.txt");
                strcpy(outFile, "outQuickAsce.txt");
                break;
            case 2:
                strcpy(inFile, "inQuickDesc.txt");
                strcpy(outFile, "outQuickDesc.txt");
                break;
            case 3:
                strcpy(inFile, "inQuickRand.txt");
                strcpy(outFile, "outQuickRand.txt");
                break;
            default:
